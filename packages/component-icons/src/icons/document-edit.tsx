...
export interface documenteditIconProps {
  accentClassName?: string;
}

export const documenteditIcon: React.FC<documenteditIconProps> = ({ accentClassName }) => (
  <svg className="zen-stroke-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" role="img" aria-label="documentEdit">
