...
| `src/generate-styles.mts`                  | Tailwind v4 CSS 生成 | `dist/index.mjs`(tokens) と component-theme typography から `dist/{theme,utilities,index}.css` を生成                                                                         | Yarn ワークスペース全体で共通設定として利用。                                                                                                                       |
