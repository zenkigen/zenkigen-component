...
<SegmentedControl value={active} size="medium" aria-label="SegmentedControlのサンプル" onChange={setActive}>
  <SegmentedControl.Item label="サンプルコード" value="code" />
  <SegmentedControl.Item label="Stories / レイアウト例" value="stories" />
  <SegmentedControl.Item label="デザインプリンシプル" value="design" />
  <SegmentedControl.Item label="詳細仕様" value="specification" />
</SegmentedControl>
