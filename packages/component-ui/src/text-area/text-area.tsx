...
function TextAreaInner(
  ...
  const { className: _className, ...restTextAreaProps } = props as typeof props & { className?: string };
  ...
  const describedByBaseId = restTextAreaProps.id ?? autoGeneratedId;
  ...
  const describedByFromProps =
    typeof restTextAreaProps['aria-describedby'] === 'string' ? restTextAreaProps['aria-describedby'] : null;
  ...
  const ariaInvalidFromProps = restTextAreaProps['aria-invalid'];
