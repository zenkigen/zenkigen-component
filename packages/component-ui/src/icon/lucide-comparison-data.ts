...
export const iconComparisonEntries: IconComparisonEntry[] = [
  ...
  },
  {
    name: 'attention',
    status: 'replace',
    note: '状態アイコン（塗り円＋！）。デザインチーム確認済みで置換確定（2026-08-04）。論点 A の 4 種のうち本件と warning のみ先行確定',
  ...
  },
  {
    name: 'warning',
    status: 'replace',
    note: '状態アイコン（塗り三角＋！）。デザインチーム確認済みで置換確定（2026-08-04）。論点 A の 4 種のうち本件と attention のみ先行確定',
