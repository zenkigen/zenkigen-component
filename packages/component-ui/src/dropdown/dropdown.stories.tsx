  ...
  render: () => (
    <div className="m-5 flex flex-col gap-8">
      <div className="flex h-[120px] items-center gap-2">
        <IconButton icon="angle-up" size="small" variant="text" onClick={action('up')} aria-label="上へ" />
        <IconButton icon="angle-down" size="small" variant="text" onClick={action('down')} aria-label="下へ" />
        <IconButton icon="edit" size="small" variant="text" onClick={action('edit')} aria-label="編集" />
        <Dropdown variant="text" size="x-small" target={<Icon name="more" size="small" color="icon01" />} isArrowHidden>
          <Dropdown.Menu horizontalAlign="right">
      ...
      <div className="flex h-[120px] w-[320px] items-center gap-2">
