...
export const OpenXLarge: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'size="x-large" でカレンダーを開いた状態。x-large はトリガーだけでなくカレンダーも拡大される（342×445px）。x-large はモバイル向けで、カレンダーはスクロールしないため、ビューポート幅 358px 以上かつトリガーの上下いずれかに 453px 以上の余白が確保できるレイアウトでのみ使用すること。',
      },
    },
  },
};
