...
type TextInputComponent = ForwardRefExoticComponent<InternalProps & RefAttributes<HTMLInputElement>> & {
  HelperMessage: typeof TextInputHelperMessage;
  ErrorMessage: typeof TextInputErrorMessage;
};

const TextInput = forwardRef<HTMLInputElement, InternalProps>(
  (
    {
      size = 'medium',
      isError = false,
