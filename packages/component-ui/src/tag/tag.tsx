...
export function Tag({ id, children, color, variant = 'normal', size = 'medium', isEditable, onDelete }: Props) {
  const wrapperClasses = clsx('flex', 'items-center', 'justify-center', {
    ...
    'h-[18px] typography-label11regular': isEditable && size === 'x-small',
    'h-[16px] typography-label12regular': !isEditable && size === 'small',
    'h-[20px] typography-label12regular': isEditable && size === 'small',
